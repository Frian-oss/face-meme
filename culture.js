...
export const CULTURE_GESTURES = [
  ...
  },
  {
    ...
    desc: 'Middle finger extended, other fingers folded',
    tagline: 'The most universal gesture — with very different “weights” everywhere.',
    meanings: [
      { flag: '🌍', country: 'Global', meaning: 'An insult — understood almost everywhere' },
      { flag: '🇺🇸', country: 'USA', meaning: 'A strong insult, roughly equal to the F-word' },
      { flag: '🇬🇧', country: 'UK', meaning: '“Two fingers” (palm inward) is the older British insult' },
      { flag: '🇯🇵', country: 'Japan', meaning: 'Seen as childish rather than deeply offensive' },
      { flag: '🇷🇺', country: 'Russia', meaning: 'Extremely offensive — can escalate quickly' },
    ],
    takeaway: 'Even the world\u2019s most universal gesture is translated differently in every culture.',
